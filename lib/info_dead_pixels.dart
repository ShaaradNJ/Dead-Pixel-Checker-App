      ...
      body: const Column(
        children: [
           Padding(
             ...
             child: Text('''Dead pixels are defective pixels on a display screen that do not function as intended. These can occur on LCD (liquid crystal display), OLED (organic light-emitting diode), or other types of screens. Dead pixels are usually classified into a few types based on their behavior:
